...
export default function HubModal({ onClose, currentNodes, currentEdges, currentWorkflowName, onImport }) {
  ...
  const handlePublish = async () => {
    ...
    if (!currentNodes.length) {
      setPublishResult({ error: 'Der aktuelle Workflow ist leer. Füge zuerst Nodes hinzu.' });
      return;
    }
    setPublishing(true);
          ...
          <div className="flex items-center justify-between mb-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-white/40">Workflows entdecken und teilen</p>
              </div>
            </div>
            <button
              onClick={onClose}
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-3">
                ...
                {!browseLoading && !browseError && flows.length === 0 && (
                  <div className="flex flex-col items-center justify-center py-16 gap-3">
                    ...
                    <p className="text-sm text-white/30">Keine Workflows gefunden.</p>
                  </div>
                )}
              ...
              {!browseLoading && pagination.pages > 1 && (
                <div className="px-6 py-4 border-t border-white/5 bg-black/20 shrink-0 flex items-center justify-between">
                  <span className="text-[11px] text-white/30">
                    {pagination.total} Workflows gesamt
                  </span>
                ...
                {publishResult === 'ok' ? (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white/40 mt-1">Dein Workflow ist jetzt in der Community verfügbar.</p>
                    </div>
                    <button
                  ...
                  >
                    <div className="p-4 bg-blue-500/5 rounded-2xl border border-blue-500/15">
                      <p className="text-[11px] text-blue-300/70 leading-relaxed">
                        Du veröffentlichst den aktuell geladenen Workflow ({currentNodes.length} Nodes).
                    ...
                    <div className="space-y-1.5">
                      ...
                      <textarea
                        placeholder="Was macht dieser Workflow? Welches Problem löst er?"
                        rows={3}
                    ...
                    >
                      {publishing
                        ...
                        : <><Upload size={15} /> Workflow veröffentlichen</>}
                    </button>
                  </motion.div>
                )}
              </AnimatePresence>
